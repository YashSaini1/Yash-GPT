...
let typedAnimationChat = () => {
  let options = {
    strings: [
      ...
      "Debug this code",
      "Best Free Food's APIs",
      "Easy ways to earn money as a student.",
    ],
    typeSpeed: 40,
    loop: true,
    backSpeed: 20,
...
let typedAnimationImg = () => {
  let options = {
    strings: [
      "Generate your Imagination in seconds!",
      "A whimsical garden filled with oversized flowers",
      "Haunted mansion",
      "Alien marketplace",
      "Magical library",
      "A cozy cabin nestled in a snow-covered mountain valley.",
    ],
    typeSpeed: 40,
    loop: true,
    backSpeed: 20,
